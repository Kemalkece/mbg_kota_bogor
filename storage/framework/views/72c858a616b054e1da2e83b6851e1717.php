...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['regulasis']));
...
foreach (array_filter((['regulasis']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<h5 class="section-title text-4xl font-extrabold text-[#071E49] mb-5">
    Peraturan & Regulasi
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($regulasis->isEmpty()): ?>
        ...
        <div class="regulasi-wrapper flex flex-col lg:flex-row gap-8" data-aos="fade-up">
            ...
            <div class="regulasi-sidebar w-full lg:w-1/4 bg-white p-6 rounded-2xl shadow-lg h-fit sticky top-24">
                ...
                <ul class="regulasi-menu list-none pl-0 space-y-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $regulasis->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $regulasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="#reg-<?php echo e($regulasi->id); ?>"
                            ...
                            data-target="card-<?php echo e($regulasi->id); ?>">
                            <?php echo e($regulasi->judul); ?>
                ...
                <a href="<?php echo e(route('detail_regulasi')); ?>" class="btn-selengkapnya-regulasi">
                    Selengkapnya
                </a>
            </div>
            ...
            <div class="regulasi-content w-full lg:w-3/4">
                ...
                <div class="regulasi-card-compact bg-white p-8 rounded-2xl shadow-lg flex-col lg:flex-row gap-6 animate-[fadeIn_0.5s_ease-out]"
                    id="card-<?php echo e($regulasi->id); ?>"
                    ...
                    <div class="regulasi-card-main flex-1">
                        ...
                        <div class="regulasi-card-meta text-sm text-gray-500 mb-4 flex items-center gap-2">
                            ...
                            <?php echo e(\Carbon\Carbon::parse($regulasi->tahun)->format('Y')); ?>

                        </div>

                        <p class="regulasi-card-desc text-gray-600 leading-relaxed mb-6">
                            <?php echo e($regulasi->deskripsi); ?>

                        </p>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($regulasi->penjelasan): ?>
...
</section><?php /**PATH C:\laragon\www\mbg_kota_bogor\resources\views/components/regulasi.blade.php ENDPATH**/ ?>