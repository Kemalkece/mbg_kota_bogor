...
<body>
    ...
    <div class="container py-5 d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="row justify-content-center w-100">
            ...
            <div class="col-lg-9">
                ...
                <!-- No Results Message -->
                <div id="noResults" class="text-center py-5" style="display: none; padding: 60px 20px !important;">
                    <div class="mb-4">
                        <i class="bi bi-search text-muted" style="font-size: 5rem; opacity: 0.5;"></i>
                    </div>
                    <h3 class="fw-bold text-secondary mb-3" style="font-size: 1.8rem;">Dokumen tidak ditemukan</h3>
    ...
    <script nonce="<?php echo e(Vite::cspNonce()); ?>">
        ...
        function doFilter() {
            ...
            const allCards = document.querySelectorAll('.searchable-item');
            let visibleCount = 0;
            ...
            allCards.forEach((card) => {
                ...
                const hasSearchMatch = (searchQuery === '') || (title.includes(searchQuery) || meta.includes(searchQuery));
                const hasCategoryMatch = (activeCategory === 'all') || (String(categoryId) === String(activeCategory));

                if (hasSearchMatch && hasCategoryMatch) {
            ...
            // Gunakan inline style untuk lebih reliable
            if (visibleCount === 0) {
