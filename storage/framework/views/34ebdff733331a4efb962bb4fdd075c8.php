...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['collapsible' => true,'icon' => 'heroicon-o-shield-check']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['collapsible' => true,'icon' => 'heroicon-o-shield-check']); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\mbg_kota_bogor\resources\views\filament\admin\pages\backup-control.blade.php ENDPATH**/ ?>