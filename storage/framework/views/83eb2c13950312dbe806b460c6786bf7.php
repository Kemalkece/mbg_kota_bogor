...
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8">
            ...
            <form class="mt-8 space-y-6" action="<?php echo e(route('change-password.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\mbg_kota_bogor\resources\views\auth\change-password.blade.php ENDPATH**/ ?>