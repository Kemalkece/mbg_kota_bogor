    ...
    <div class="container">
        ...
        <div class="data-wrapper">
            ...
            <div style="text-align:center;padding:40px 0;">
                <h4 style="font-weight:800;color:#071E49;">Belum Ada Data Penyaluran</h4>
                <p style="color:#9CA3AF;">Data distribusi akan diperbarui secara berkala.</p>
            </div>
            @else
            <div class="slider-container" style="position:relative;overflow:visible;">
                ...
                <div id="slider" style="display:flex;gap:24px;overflow-x:auto;scroll-behavior:smooth;padding:10px 5px;">
                    @foreach ($dataPenyalurans as $index => $data)
                    <div style="
                        min-width:280px;max-width:400px;min-height:100px;max-height:170px;
                        ...
                        <div style="flex:1;">
                            <h3 style="font-size:18px;font-weight:800;margin-bottom:8px;">{{ $data->judul }}</h3>
                            <p style="font-size:14px;line-height:1.6;">{{ $data->deskripsi }}</p>
                        </div>
                        <div style="flex-shrink:0;">
                            <img src="{{ asset('storage/' . $data->gambar) }}" alt="{{ $data->judul }}"
                                style="width:95px;height:130px;object-fit:cover;border-radius:14px;">
                        </div>
                    </div>
                    @endforeach
                </div>
...
{{-- Tidak ada <script> inline di sini. scrollSlider sudah ada di mbg.js --}}